...
class App {
  ...
  createMedias(items, bend = 1, textColor, borderRadius, font) {
    const defaultItems = [
      { image: `./CircularMenu/1.jpg`, text: 'Plastic Pollution' },
      { image: `./CircularMenu/2.jpg`, text: 'Overfishing' },
      { image: `./CircularMenu/3.webp`, text: 'Coral Bleaching' },
      { image: `./CircularMenu/6.webp`, text: 'Oil Spills' },
      { image: `./CircularMenu/7.webp`, text: 'Illegal Fishing' },
      { image: `./CircularMenu/9.webp`, text: 'Marine Debris' },
      { image: `./CircularMenu/11.webp`, text: 'Ocean Acidification' },
    ];
